...
const Footer = () => {
  return (
    <div className="bg-gray-800" id="footer">
      <div className="container mx-auto px-4 text-white py-2">
        <footer className="text-white body-font">
          <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            <a className="flex text-white title-font font-medium items-center md:justify-start justify-center text-gray-900">
              <svg
              ...
              <span className="ml-3 text-xl text-white">TRT</span>
            </a>
