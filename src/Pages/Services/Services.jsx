    ...
    <div  className="services" id="services">
      <div className="container mx-auto px-4">
        <div className="section-title mx-auto text-center py-10">
          ...
          <p className="">Find what am I doing?.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-4 py-10">

          <div className="box hover:shadow-2xl  text-center bg-accent p-12 rounded-lg">
            <div className="icon">
          ...
          <div className="box hover:shadow-2xl text-center bg-accent p-12 rounded-lg">
            ...
            <div className="content">
              ...
              <p className="">
              I can develop a site with MERN also, With various tools
              </p>
            </div>
          </div>
